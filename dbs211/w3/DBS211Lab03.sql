...
/*3. Display customer number, customer name, contact first name and contact last name, and phonefor all customers in Paris. (hint: be wary of case sensitivity)*/

SELECT customernumber, customername, contactfirstname, contactlastname, phone
FROM customers
WHERE LOWER(city) = 'paris';

/*4. Repeat the previous Query with a couple small changes:a. The contact’s first and last name should be in a single column in the format “lastname,firstname”.b. Show customers who are in Canada*/
...
WHERE LOWER(contactfirstname) = 's%e%';
...
VALUES (9999, 'Gauro', 'Ankush', 'x977', 'agauro@myseneca.ca', 4, 1088, 'Cashier');
...
INSERT INTO employees (employeenumber, lastname, firstname, extension, email, officecode, reportsto, jobtitle) 
VALUES (0000, 'Thomas', 'Shelby', 'x1', 'ajank1yu@gmail.com', 4, 9999, 'Cashier');

/*15.	Create a statement to Delete yourself from the database.  Did it work?  If not, why?*/

DELETE FROM employees
WHERE employeenumber = 9999;
/*No it didn't work and it throwed Error report -
ORA-02292: integrity constraint (DBS211_241ZBB10.EMP_RTEMP_FK) violated - child record found

This is because for deleting the parent record we have to first delete the child record; meaning I have to delete the record
I just created with employee number 0000 to delte this record*/
...
INSERT ALL
INTO employees VALUES (9999, 'Gauro', 'Ankush', 'x977', 'agauro@myseneca.ca', 4, 1088, 'Cashier')
INTO employees VALUES (0000, 'Thomas', 'Shelby', 'x1', 'ajank1yu@gmail.com', 4, 1088, 'Cashier')
SELECT * FROM dual;

/*18.	Create a single statement to delete both yourself and the fake employee.*/

DELETE FROM employees
WHERE employeenumber = 0000 OR employeenumber = 9999;
